<template>
  <div>
    ...
    <div class="bg-white rounded shadow">
      <div v-for="user in usersList" :key="user.id" class="flex justify-between items-center p-4 border-b">
        <div>
      ...
      <div v-if="usersList.length === 0" class="p-4 text-center text-gray-500">
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded p-4">
        <p>Supprimer "{{ userToDeleteName }}" ?</p>
        <p class="text-red-600 text-sm mt-2">⚠️ Tous ses posts et commentaires seront supprimés.</p>
