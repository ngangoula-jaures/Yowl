...
<template>
    <div class="min-h-screen bg-gray-50 text-gray-800 p-6 md:p-10 font-sans">
        <!-- Header -->
        <header class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1">Gérez et analysez les performances de Yowl.</p>
            </div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Card 1 -->
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Total Utilisateurs</h3>
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-extrabold text-gray-900">{{ props.count.userCount }}</span>
                    <span class="text-sm font-medium text-emerald-500 bg-emerald-50 px-2 py-0.5 rounded-full flex items-center">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Total Posts</h3>
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-extrabold text-gray-900">{{ props.count.postCount }}</span>
                    <span class="text-sm font-medium text-emerald-500 bg-emerald-50 px-2 py-0.5 rounded-full flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
                        </svg>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Total Commentaires</h3>
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-extrabold text-gray-900">{{ props.count.commentCount }}</span>
                    <span class="text-sm font-medium text-rose-500 bg-rose-50 px-2 py-0.5 rounded-full flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition duration-300 relative overflow-hidden group">
                ...
                <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Interactions (Likes)</h3>
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-extrabold text-gray-900">{{ props.count.likeCount }}</span>
                    <span class="text-sm font-medium text-emerald-500 bg-emerald-50 px-2 py-0.5 rounded-full flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
                        </svg>
